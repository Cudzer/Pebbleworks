...
public class PW_Items {
    ...
    public static final Supplier<Item> PEBBLE_SPAWN_EGG = ITEMS.register("pebble_spawn_egg",
            () -> new DeferredSpawnEggItem(PW_Entities.PEBBLE, 0x808080, 0x404040, new Item.Properties())
    );
